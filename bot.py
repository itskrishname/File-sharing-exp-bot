...
class Bot(Client):
    ...
    async def start(self):
        ...
        try:
            ...
            self.LOGGER(__name__).info("\nBot Stopped. Join https://t.me/Lord_Vasudev_Krishna for support")
            sys.exit()

        self.set_parse_mode(ParseMode.HTML)
        self.LOGGER(__name__).info(f"Bot Running..!\n\nCreated by \nhttps://t.me/Lord_Vasudev_Krishna")
...
| (_| (_) | |) | _|| _|| |__ | | >  <| _ \ (_) || | \__ \
 \___\___/|___/|___|_| |____|___/_/\_\___/\___/ |_| |___/
        ...
        self.LOGGER(__name__).info(f"Bot Running..! Made by @SECRECT_BOT_UPDATES")   
        ...
        try: await self.send_message(OWNER_ID, text = f"<b><blockquote> Bᴏᴛ Rᴇsᴛᴀʀᴛᴇᴅ by @SECRECT_BOT_UPDATES</blockquote></b>")
        except: pass
