...
OWNER = os.environ.get("OWNER", "Krishna") # Owner username without @
...
"""
#--------------------------------------------
CUSTOM_CAPTION = os.environ.get("CUSTOM_CAPTION", "<b>• ʙʏ @SECRECT_BOT_UPDATES</b>") #set your Custom Caption here, Keep None for Disable Custom Caption
